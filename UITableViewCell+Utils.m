...
+ (CGFloat)heightForText:(NSString *)text withImage:(BOOL)image withAccessory:(UITableViewCellAccessoryType)accessoryType withFont:(UIFont *)font inTableView:(UITableView *)tableView
{
